...
{{--
    Rendered once at the end of <body> by the app layout. Keep these OUT of <header>: its
    backdrop-blur creates a containing block that would trap `fixed` overlays in the top bar.
--}}
