...
/**
 * Optional demo content: seven sample people and five projects with history.
 * NOT run by default — the real database ships empty apart from roles and the administrator.
 *
...
class DemoDataSeeder extends Seeder
{
    ...
    {
        $admin = User::query()->admins()->orderBy('id')->firstOrFail();
